...
public class generatedClass {
    ...
    public static String dynamicDeployer = "package deployingClasses;\n" +
            "\n" +
            "\n" +
            ...
            "public class DynamicDeployTest extends AbstractSelfDescribingAlgorithm {\n" +
            "\n" +
            "      /*\n" +
            ...
            "\n" +
            "\n" +
            "   // Object t = outputs.get(keySet.toArray()[0]);\n" +
            "\n" +
            "    // System.out.println());\n" +
            "\n" +
