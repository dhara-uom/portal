                        ...
                        <div class="slate clearfix">
                            ...
                            <table  align="center" BGCOLOR="#FF0000" BORDER="0" CELLPADDING="15" CELLSPACING="0">
                                ...
                                <tr class="border_bottom">
                                    ...
                                    <th BGCOLOR="#F0AF37"><FONT COLOR=#804000 SIZE="3">UpdatedDate</FONT></th>
                                ...
                                <c:forEach items="${message}" var="workflowData" varStatus="loop">
                                    <tr class="border_bottom">
                                        ...
                                        <td>
                                            <FONT COLOR=#4B3232 SIZE="2"><c:out value="${workflowData.date}"></c:out></FONT>
                                        </td>
                                        <td>
                                            <FONT COLOR=#4B3232 SIZE="2"><c:out value="${workflowData.input}"></c:out></FONT>
                                        </td>
                                        <td>
                                            <FONT COLOR=#4B3232 SIZE="2"><c:out value="${workflowData.ouput}"></c:out></FONT>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
